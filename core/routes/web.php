...
Route::group(['middleware' => 'setlang'], function () {
    ...
    Route::group(['prefix' => 'user', 'middleware' => 'auth:web'], function () {
        ...
        Route::group(['prefix' => 'apply'], function() {
            Route::post('/', 'User\UserController@form_apply')->name('user.apply');

            Route::get('/esl-instructor', 'User\UserController@form_esl_instructor')->name('user.apply.esl');
            Route::get('/study-abroad', 'User\UserController@form_study_in_china')->name('user.apply.study');
            Route::get('/asian', 'User\UserController@form_asian')->name('user.apply.asian');
            Route::get('/me', 'User\UserController@form_me')->name('user.apply.me');
            Route::get('/schengen', 'User\UserController@form_schengen')->name('user.apply.schengen');
            Route::get('/travel-guide', 'User\UserController@form_travel_guide')->name('user.apply.travel');
            Route::get('/import-export', 'User\UserController@form_import_export')->name('user.apply.import-export');
        });
    });
    // ***************************** USER ROUTE END ***************************************//
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus']], function () {
    ...
    // Contact Services Agents
    Route::get('/agents', 'ContactServicesCategoryController@agents')->name('admin.agents');

    Route::get('/agents/create', 'ContactServicesCategoryController@create')->name('admin.agents.create');
    Route::post('/agents/create', 'ContactServicesCategoryController@create');
        
    Route::get('/agents/edit/{id}', 'ContactServicesCategoryController@edit')->name('admin.agents.edit');
    Route::post('/agents/edit/{id}', 'ContactServicesCategoryController@edit');

    Route::post('/agents/delete', 'ContactServicesCategoryController@delete')->name('admin.agents.delete');

    // Applications
    Route::group(['prefix' => "applications"], function() {
        Route::get('/', 'ApplicationController@applications')->name('admin.applications');
        
        Route::post('/process', 'ApplicationController@process')->name('admin.applications.process');
        Route::post('/accept', 'ApplicationController@accept')->name('admin.applications.accept');
        Route::post('/reject', 'ApplicationController@reject')->name('admin.applications.reject');
    });
    ...
    Route::group(['middleware' => 'checkpermission:Dynamic Page'], function () {
        // Dynamic Page  Route
        Route::get('/services', 'Admin\DynamicpageController@dynamic_page')->name('admin.dynamic_page');
        Route::get('/services/add', 'Admin\DynamicpageController@add')->name('admin.dynamic_page.add');
        Route::post('/services/store', 'Admin\DynamicpageController@store')->name('admin.dynamic_page.store');
        Route::post('/services/delete/{id}/', 'Admin\DynamicpageController@delete')->name('admin.dynamic_page.delete');
        Route::get('/services/edit/{id}/', 'Admin\DynamicpageController@edit')->name('admin.dynamic_page.edit');
        Route::post('/services/update/{id}/', 'Admin\DynamicpageController@update')->name('admin.dynamic_page.update');
    });
