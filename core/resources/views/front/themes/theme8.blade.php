                                ...
                                <div class="banner-content text-center">
                                    ...
                                    <ul class="banner-btns">
                                        ...
                                        <li class="wow fadeInUp" data-wow-delay="0.8s">
                                            <a class="main-btn transparent-border-btn rounded-btn" target="_blank" href="http://lovellefashion.com/">Lovelle Fashion</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row text-center ">
                    @foreach ($counters as $id=>$item)
                        <div class="col-lg-3 col-sm-6 boxScroll{{ $id }}">
                            <div class="fun-box">
                            <div class="icon">
                                <i class="{{ $item->icon }}"></i>
                            </div>
                            <div class="counter-wrapper">
                                <h3 class="counter" id="value{{ $id }}" data-stop="{{ $item->number }}" data-speed="0.1">
                                    0
                                </h3>
                            </div>
                        ...
                        <script>
                            new CountUp('.boxScroll{{ $id }}', '#value{{ $id }}');
                        </script>
                    @endforeach
                </div>
            </div>
