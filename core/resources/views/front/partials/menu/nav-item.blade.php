...
<div class="site-nav-menu">
    <ul class="primary-menu">
        ...
        {{-- <li class="submenu-wrapper pore">
            <a class="sm-link p-link" href="#">Services</a>
            <ul class="submenu">
                <li>
                    <a href="#">Sublink</a>
                    <ul class="submenu">
...
<div class="header-extra d-flex align-items-center">
    ...
    <div class="my-dropdown" style="visibility: hidden;">
    ...
    @if( $visibility->is_quote_page == 1)
        ...
        <div class="navbar-btn">
            <a href="http://lovellefashion.com/">Shop with Us<i class="fal fa-long-arrow-right"></i></a>
        </div>
