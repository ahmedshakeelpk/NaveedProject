...
class FrontendController extends Controller
{
    ...
    public function contact() {
        ...
        // Get all services and their subcategories
        $data['contact_services'] = ContactServices::all();
    ...
    public function contactSubmit(Request $request){
        ...
        $contact_service_category_id = $request->contact_service_category_id;

        $contact_service_category = ContactServicesCategories::find($contact_service_category_id);
        ...
        try {
            ...
            // If there is a detected agent
            if ($contact_service_category) {
                $mail->addCC($contact_service_category->agent_email);
            }
